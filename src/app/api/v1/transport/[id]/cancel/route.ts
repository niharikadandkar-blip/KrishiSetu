...
import { cancelTransportSchema } from '@/lib/validations/phase6';
...
export async function POST(
  ...
  try {
    ...
    const validation = cancelTransportSchema.safeParse({ ...body, requestId, userId });
    ...
    const cancelledRequest = await transportRepository.cancelTransportRequest(validation.data);
